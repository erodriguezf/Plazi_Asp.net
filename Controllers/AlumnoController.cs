...
namespace HolamundoMVC.Controllers
{
    public class AlumnoController : Controller
    {
        ...
        public AlumnoController(EscuelaContex context)
        {
            _context = context;
        }
        ...
        {
            var escuelaContex = _context.Alumnos.Include(a => a.Curso);
        ...
        public async Task<IActionResult> Create([Bind("CursoId,Nombre,Id")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CursoId,Nombre,Id")] Alumno alumno)
        {
            if (id != alumno.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'EscuelaContex.Alumnos'  is null.");
            }
            var alumno = await _context.Alumnos.FindAsync(id);
            if (alumno != null)
            {
